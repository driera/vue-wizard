...
function vueTest() {
    _vue2.default.component('step-navigation-step', {
    ...
    _vue2.default.component('step-navigation', {
        template: '#step-navigation-template',

        props: ['steps', 'currentstep']
    });

    _vue2.default.component('step', {
...
},{"vue/dist/vue.js":3}],2:[function(require,module,exports){
'use strict';

/* Modules */

var _vueTest = require('./inits/vue-test');
...
/* Initial setup */
new _vueTest2.default();

},{"./inits/vue-test":1}],3:[function(require,module,exports){
(function (global){
/*!
 * Vue.js v2.3.4
